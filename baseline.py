"""
Baseline inference script for the SQL Data Analyst Investigation Environment.

Rule-based agent that follows predefined investigation strategies for each task.
No LLM or API key required — fully deterministic and reproducible.

Usage:
    python baseline.py
    python baseline.py --base-url http://localhost:8001
    python baseline.py --task anomaly_diagnosis
"""
...
async def main():
    parser = argparse.ArgumentParser(description="SQL Data Analyst Baseline Agent (Rule-Based)")
