...
import { SaleRecord, SqlLogMessage, SwarmResponse, ChatMessage } from '../types';
...
export default function Workspace({
  ...
  const [executionLogs, setExecutionLogs] = useState<SqlLogMessage[]>([]);
  ...
  const handleLaunchSwarm = (queryText: string) => {
    ...
    ws.onmessage = (event) => {
      ...
      if (packet.type === 'log') {
        ...
        // Increment query count in Firestore
        if (user) {
